        ...
        <div class="container">
            <div class="header_block">
                <div class="header_left">
                    ...
                    <NuxtLink 
                    to="/" 
                    class="headerLeft_link"
                    v-if="mainStore.user.token"
                    >
                ...
                <div class="header_right" v-if="mainStore.user.token">
                    <div class="headerRight_actions">
                        <button class="headerRightActions_button"><img src="/icons/addIcon.svg" alt="AddIcon"></button>
                    </div>
                    <NuxtLink to="/" class="headerRight_avatar"><img src="/server/avatars/avatar.jpg" alt="AvatarIcon"></NuxtLink>
                </div>
                <div class="header_right" v-else>
                    <NuxtLink class="headerRight_login" to="/login">Войти</NuxtLink>
                    <div class="header_line"></div>
                    <NuxtLink class="headerRight_reg" to="/refistration">Зарегистрироваться</NuxtLink>
                </div>
            </div>
